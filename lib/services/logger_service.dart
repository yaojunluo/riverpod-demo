...
/// [ImichLogger]是一个自定义记录器，它是在[logging]包的基础上构建的。
/// 使用“debugPrint”方法将日志写入数据库并写入控制台。
///
/// 当超过类中的“maxLogEntries”（默认值为200）属性时，将删除日志。
///
/// 可以通过调用“shareLogs”方法共享日志，该方法将打开共享对话框并生成csv文件。
class LoggerService {
  ...
  LoggerService._internal() {
    ...
    Logger.root.level = Level.LEVELS[5];
